...
<br />All weather access keys must be obtained from the weather providers websites as <b>Yr.no (Norwegian Metrological Institute) are undergoing changes to their web services and no longer provider weather data for places outside of Europe for the time being.<br />
